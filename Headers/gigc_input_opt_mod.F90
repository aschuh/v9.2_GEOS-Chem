...
!
  ...
  TYPE, PUBLIC :: OptInput
     ...
     CHARACTER(LEN=255), POINTER :: ND48_SARR(:)
...
!
    ...
    ALLOCATE( Input_Opt%ND48_SARR( 1000 ), STAT=RC )
...
!BOC
    ...
    IF ( ASSOCIATED( Input_Opt%ND48_SARR) ) THEN
       DEALLOCATE( Input_Opt%ND48_SARR )
    ENDIF
